	...
	public class CameraShotInspector : ActionClipInspector<CameraShot> {
		...
		public override void OnInspectorGUI(){
			...
			if (action.targetShot != null){
				...
				if (action.targetShot.dynamicController.composer.trackingMode == DynamicCameraController.Composer.TrackingMode.Composition){
				...
				////The shot dynamic operator settings
