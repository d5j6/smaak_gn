...
namespace Slate{
	...
	[Description("Camera Shots can be keyframed directly within this clip. You don't need to create an Actor Group to animate the shot (even though you can if desired).")]
	public class CameraShot : DirectorActionClip {
		...
		//TODO: Deprecate, but kept serialized in case someone is using them
		[HideInInspector]
		...
		///shots should update across the whole cutscene length regardless of whether or not this clip is in range
